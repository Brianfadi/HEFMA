  ...
  <main className="max-w-5xl mx-auto py-12 px-4">
    ...
    <section className="mb-8">
      ...
      <ul className="space-y-4">
        ...
        <li className="bg-white shadow rounded-lg p-4">
          <div className="font-bold text-lg">5 Trends in Facility Managers for 2025</div>
        ...
        <li className="bg-white shadow rounded-lg p-4">
          <div className="font-bold text-lg">The Future of Facility Managers: Trends and Insights</div>
        ...
        <li className="bg-white shadow rounded-lg p-4">
          <div className="font-bold text-lg">Maximizing Efficiency in Facility Managers</div>
    ...
    <section className="mb-8">
      ...
      <div className="bg-white shadow rounded-lg p-4">
        <div className="font-bold text-lg">The Impact of Technology on Facility Managers</div>
    ...
    <section className="mb-8">
      ...
      <ul className="space-y-4">
        <li className="bg-white shadow rounded-lg p-4">
          <div className="font-bold text-lg">Facility Managers</div>
