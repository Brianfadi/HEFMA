    ...
    <section className="mb-8">
      ...
      <ul className="space-y-4">
        ...
        <li className="bg-white shadow rounded-lg p-4">
          ...
          <a href="#" className="text-blue-700 underline">Download</a>
        </li>
        <li className="bg-white shadow rounded-lg p-4">
    ...
    <section>
      ...
      <div className="mb-4">
        ...
        <ul className="flex space-x-4 mb-4">
          <li><a href="#" className="text-blue-700 underline">All</a></li>
          <li><a href="#" className="text-blue-500">Safety Guidelines</a></li>
          <li><a href="#" className="text-blue-500">Facility Management</a></li>
          <li><a href="#" className="text-blue-500">Industry Reports</a></li>
        </ul>
      </div>
      <ul className="space-y-4">
        <li className="bg-gray-50 rounded-lg p-4">
          <div className="font-bold">Safety Guidelines for Facility Managers</div>
          <a href="#" className="text-blue-700 underline">View PDF</a>
        </li>
        <li className="bg-gray-50 rounded-lg p-4">
